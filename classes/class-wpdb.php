...
* @version 1.0.4 
*/
//class STARCITIZENFANSITEKIT_DB extends STARCITIZENFANSITEKIT_UpdatePlugin { commented 14092014
class STARCITIZENFANSITEKIT_DB {     
    /**
    ...
    */
    public function options_beginning_with( $prependvalue){    
        ...
        // loop through each option record and check their name value for starcitizenfansitekit_ at the beginning
    ...
    */
     ...
     * 2. Another approach is using starcitizenfansitekit_WP_SQL_get_tables() and checking the array for the table, this is error free
     * 
     * @author Ryan R. Bayne
     * @package Star Citizen Fan Site Kit
     * @since 7.0.0
...
}// end class STARCITIZENFANSITEKIT_DB
?>