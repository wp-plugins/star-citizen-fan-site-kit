...
* @version 1.0
*/
class STARCITIZENFANSITEKIT_Help {
    ...
    * @param string $readmoreurl   i.e. http://webtechglobal.co.uk/blog/wordpress/starcitizenfansitekit/how-to-create-new-projects
    ...
    */
    public function get_help_array() {   
        ...
        // PAGE: main
        $h[ 'main' ][ 'pageinfo' ] = self::enterpage( __( 'Welcome', 'starcitizenfansitekit' ), __( 'My name Ryan Bayne and I created this plugin. I can also help you at anytime. This help tab is not complete and will eventually offer help content for every feature.', 'starcitizenfansitekit' ), STARCITIZENFANSITEKIT_PORTAL, STARCITIZENFANSITEKIT_YOUTUBEPLAYLIST );

        // PAGE: generalsettings (EXAMPLE ONLY THIS PAGE DOES NOT EXIST)      
        $h[ 'generalsettings' ][ 'pageinfo' ][ 'pagetitle' ]       = __( 'General Post Settings', 'starcitizenfansitekit' ); 
        $h[ 'generalsettings' ][ 'pageinfo' ][ 'pageabout' ]       = __( 'Beta Testing: These settings reflect what WordPress already has to offer. You will find these settings on the Edit Post screen and in most other .csv import plugins.', 'starcitizenfansitekit' );    
